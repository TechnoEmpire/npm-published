...
- You can set the animation position by specifying the position prop when rendering the Content component. Choose either `'slide-up'`,`'slide-down'` based on your preference.
